...
from app.views import tidligere_konserter, tilbud_liste_bookingsjef, band_search
...
urlpatterns = [
    ...
    url(r'^legg_til_behov/(?P<name>\w+)$', legg_til_behov_manager, name='legg_til_behov_manager'),
